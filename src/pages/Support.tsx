...
const Support = () => {
  useEffect(() => { document.title = "Support - Céilí Melbourne"; }, []);
  return (
      ...
      <main className="container flex-1 py-10">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-sm mt-8 max-w-none text-foreground">
            <h2>Contact Us</h2>
            <p>
              For any questions, issues, or feedback about Céilí Melbourne, please email us at{" "}
              <a href="mailto:support@ceilimelbourne.com">support@ceilimelbourne.com</a>. We aim to respond within 2 business days.
            </p>
            ...
            <p>
              ...
              <a href="mailto:support@ceilimelbourne.com">support@ceilimelbourne.com</a> with details and we will investigate promptly.
            </p>
            ...
            <p>
              ...
              <a href="mailto:support@ceilimelbourne.com">support@ceilimelbourne.com</a> and we'll help you get access.
            </p>
