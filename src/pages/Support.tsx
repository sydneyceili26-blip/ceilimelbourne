...
const faqs = [
  ...
  },
  {
    ...
    answer: "Email us at support@ceilimelbourne.com with details and we'll investigate promptly. Include the listing title or username if you can.",
  },
  {
    icon: Mail,
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Email us at{" "}
                  <a href="mailto:support@ceilimelbourne.com" className="font-medium text-primary underline-offset-4 hover:underline">
                    support@ceilimelbourne.com
                  </a>{" "}
